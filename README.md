...
- VirusTotal YARA: [Identified a ~vulnerability~ bug](https://github.com/VirusTotal/yara/releases/tag/v4.5.3) that allows log injection which can be leveraged to evade detection
